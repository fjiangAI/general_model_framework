...
from tools.enum import RelationEnum
...
def token_pair(tokenizer, text_a, text_b=None, max_seq_length=512):
    ...
    assert len(attention_mask) == max_seq_length
    assert len(token_type_ids) == max_seq_length
    return input_ids, attention_mask, token_type_ids, input_len
