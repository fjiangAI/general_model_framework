...
from metrics.custom_metrics import ClassReport
...
from model import tokenization_albert, tokenization_bert
...
from tools.enum import ModelType
...
def main():
    ...
    # bert model
    tokenizer = tokenization_bert.BertTokenizer(vocab_file=args.vocab_file, do_lower_case=args.do_lower_case,spm_model_file=args.spm_model_file)
